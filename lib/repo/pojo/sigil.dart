...
class Sigils {
  ...
  //Flash Construct
  static const Sigil viscerblade = Sigil("viscerblade", "flash_construct", [], [], []);
  static const Sigil thornSkinned = Sigil("thorn_skinned", "flash_construct", [], [], []);
  static const Sigil crimsonGout = Sigil("crimson_gout", "flash_construct", [], [], []);
  static const Sigil regenerative = Sigil("regenerative", "flash_construct", [], [], []);
  static const Sigil woundedShard = Sigil("wounded_shard", "flash_construct", [], [], []);
  static const Sigil skinned = Sigil("skinned", "flash_construct", [], [], []);

  //Ferathrope
  static const Sigil echolocation = Sigil("echolocation", "ferathrope", [], [], []);
  static const Sigil pitOrgan = Sigil("pit_organ", "ferathrope", [], [], []);
  static const Sigil venomousBite = Sigil("venomous_bite", "ferathrope", [], [], []);
  static const Sigil emberFlesh = Sigil("ember_flesh", "ferathrope", [], [], []);

  //Vampire
  static const Sigil charming = Sigil("charming", "vampire", [], [], []);
  static const Sigil predatorSense = Sigil("predator_sense", "vampire", [], [], []);

  //Witch
  static const Sigil bookOfSecrets = Sigil("book_of_secrets", "witch", [], [], []);
  static const Sigil bookOfSpikes = Sigil("book_of_spikes", "witch", [], [], []);
  static const Sigil bookOfMirrors = Sigil("book_of_mirrors", "witch", [], [], []);

  // Blight Weaver
  static const Sigil feverish = Sigil("feverish", "blight_weaver", [], [], []);
  static const Sigil rotShaper = Sigil("rot_shaper", "blight_weaver", [], [], []);
  static const Sigil fleshBender = Sigil("flesh_bender", "blight_weaver", [], [], []);

  // Hunter
  static const Sigil painMaster = Sigil("pain_master", "hunter_orden", [], [], []);
  static const Sigil hollowSouled = Sigil("hollowsouled", "hunter_orden", [], [], []);
  static const Sigil hummerSworn = Sigil("hummer_sworn", "hunter_orden", [], [], []);
  static const Sigil daggerMaster = Sigil("dagger_master", "hunter", [], [], []);
  static const Sigil rapierMaster = Sigil("rapier_master", "hunter", [], [], []);
  static const Sigil masterOfWeaves = Sigil("master_of_weaves", "hunter", [], [], []);
}
