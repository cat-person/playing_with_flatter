...
//         consoleTab(text: "Normal", logType: LogType.normal),
//         const SizedBox(width: 15),
//         consoleTab(text: "Http", logType: LogType.http),
//         const SizedBox(width: 15),
//         consoleTab(text: "Error", logType: LogType.error),
//         const SizedBox(width: 15),
//         consoleTab(text: "Logs", logType: LogType.logs),
//         const SizedBox(width: 15),
//         consoleTab(text: "Sql", logType: LogType.sql),
//       ],
//     );
//   }
...
//               const Divider(color: Colors.black, thickness: 0.2),
//               StatefulBuilder(
//                 builder: (context, responseSetState) {
...
//             ],
//           ),
//           Positioned(right: 0, child: CopyWidget(text: log.curlCommand)),
//         ],
//       ),
//     );
//   }
